...
revoke all PRIVILEGES on schema extensions from netocourier


GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO netocourier

GRANT usage extension  TO netocourier
...
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA extensions TO netocourier
...
select extensions.uuid_generate_v4() -- собственно сам генератор
...
DECLARE 	id1 uuid = (select extensions.uuid_generate_v4());
...
DECLARE 
	   id1 uuid = (select extensions.uuid_generate_v4());
